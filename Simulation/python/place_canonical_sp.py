...
# self
import point_cloud
from place_canonical_sp_params import Parameters
...
def main():
  ...
  sceneDirectory = "/home/mgualti/Data/GeomPickPlace/canonical_scenes_test1_5objects"
  ...
  showSteps = False
  showWarnings = False
  saveFileName = "results-canonical-sp.mat"
  params = locals()
