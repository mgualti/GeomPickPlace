...
def main():
  ...
  showSteps = True
  showWarnings = False
  saveFileName = "results-packing-mc.mat"
  params = locals()
  ...
  for episode in xrange(randomSeed, nEpisodes):
    ...
    for t in xrange(nObjects):
      ...
      # segment objects
      startTime = time()
      segmentedClouds, segmentationProbs, segmentationDist = taskPlanner.SegmentObjects(cloud,
        modelSegmentation, scoreThreshSegmentation, useGroundTruthSegmentation)
