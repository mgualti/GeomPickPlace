...
void query_ball_point_gpu(int b, int n, int m, float radius, int nsample, const float *xyz1,
...
void group_point_gpu(int b, int n, int c, int m, int nsample, const float *points, const int *idx, float *out) {
...
void group_point_grad_gpu(int b, int n, int c, int m, int nsample, const float *grad_out, const int *idx, float *grad_points) {
...
void selection_sort_gpu(int b, int n, int m, int k, const float *dist, int *outi, float *out) {
